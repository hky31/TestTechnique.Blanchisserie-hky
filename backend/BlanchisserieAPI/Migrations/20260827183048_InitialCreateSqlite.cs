    ...
    public partial class InitialCreateSqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@blanchisserie.com", "Administrateur", true, "Système", "admin123", "admin" },
                    { 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "user@blanchisserie.com", "Utilisateur", true, "Test", "user123", "user" }
                });
